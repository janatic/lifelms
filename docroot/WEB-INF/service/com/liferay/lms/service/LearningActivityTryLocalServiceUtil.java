...
public class LearningActivityTryLocalServiceUtil {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteLearningActivityTry(long latId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteLearningActivityTry(latId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteLearningActivityTry(
		com.liferay.lms.model.LearningActivityTry learningActivityTry)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteLearningActivityTry(learningActivityTry);
	}
	...
	*/
	...
	public static LearningActivityTryLocalService getService() {
		if (_service == null) {
			...
			_service = new LearningActivityTryLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(LearningActivityTryLocalServiceUtil.class,
				"_service");
			MethodCache.remove(LearningActivityTryLocalService.class);
		}
