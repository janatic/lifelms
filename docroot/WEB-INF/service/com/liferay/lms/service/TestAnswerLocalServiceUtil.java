...
public class TestAnswerLocalServiceUtil {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteTestAnswer(long answerId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteTestAnswer(answerId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteTestAnswer(
		com.liferay.lms.model.TestAnswer testAnswer)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteTestAnswer(testAnswer);
	}
	...
	public static TestAnswerLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					TestAnswerLocalService.class.getName(), portletClassLoader);

			_service = new TestAnswerLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(TestAnswerLocalServiceUtil.class,
				"_service");
			MethodCache.remove(TestAnswerLocalService.class);
		}
