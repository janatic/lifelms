...
/**
 * The base implementation of the test question local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.TestQuestionLocalServiceImpl}.
 * </p>
 *
 * @author cvicente
 ...
 * @generated
 */
public abstract class TestQuestionLocalServiceBaseImpl
	implements TestQuestionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.TestQuestionLocalServiceUtil} to access the test question local service.
	 */
	...
	public TestQuestion addTestQuestion(TestQuestion testQuestion)
		...
		testQuestion = testQuestionPersistence.update(testQuestion, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(testQuestion);
			}
	 ...
	 */
	public TestQuestion createTestQuestion(long questionId) {
		return testQuestionPersistence.create(questionId);
	}
	...
	public void deleteTestQuestion(long questionId)
		...
		TestQuestion testQuestion = testQuestionPersistence.remove(questionId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(testQuestion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTestQuestion(TestQuestion testQuestion)
		throws SystemException {
		testQuestionPersistence.remove(testQuestion);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return testQuestionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return testQuestionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TestQuestion fetchTestQuestion(long questionId)
		throws SystemException {
		return testQuestionPersistence.fetchByPrimaryKey(questionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TestQuestion getTestQuestion(long questionId)
		throws PortalException, SystemException {
		return testQuestionPersistence.findByPrimaryKey(questionId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return testQuestionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TestQuestion> getTestQuestions(int start, int end)
		throws SystemException {
		return testQuestionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTestQuestionsCount() throws SystemException {
		return testQuestionPersistence.countAll();
	}
	...
	public TestQuestion updateTestQuestion(TestQuestion testQuestion)
		throws SystemException {
		return updateTestQuestion(testQuestion, true);
	}
	...
	public TestQuestion updateTestQuestion(TestQuestion testQuestion,
		...
		testQuestion = testQuestionPersistence.update(testQuestion, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.lms.model.TestQuestion",
			testQuestionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = testQuestionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TestQuestionLocalServiceBaseImpl.class);
