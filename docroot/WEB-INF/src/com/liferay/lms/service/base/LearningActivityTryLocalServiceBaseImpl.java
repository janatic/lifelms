...
/**
 * The base implementation of the learning activity try local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.LearningActivityTryLocalServiceImpl}.
 * </p>
 *
 * @author cvicente
...
public abstract class LearningActivityTryLocalServiceBaseImpl
	implements LearningActivityTryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.LearningActivityTryLocalServiceUtil} to access the learning activity try local service.
	 */
	...
	public LearningActivityTry addLearningActivityTry(
		...
		if (indexer != null) {
			try {
				indexer.reindex(learningActivityTry);
			}
	...
	public void deleteLearningActivityTry(long latId)
		...
		LearningActivityTry learningActivityTry = learningActivityTryPersistence.remove(latId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(learningActivityTry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteLearningActivityTry(
		LearningActivityTry learningActivityTry) throws SystemException {
		learningActivityTryPersistence.remove(learningActivityTry);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLearningActivityTriesCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.lms.model.LearningActivityTry",
	...
	private static Log _log = LogFactoryUtil.getLog(LearningActivityTryLocalServiceBaseImpl.class);
