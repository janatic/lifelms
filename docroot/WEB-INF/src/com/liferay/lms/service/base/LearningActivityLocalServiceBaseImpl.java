...
public abstract class LearningActivityLocalServiceBaseImpl
	implements LearningActivityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public LearningActivity addLearningActivity(
		...
		learningActivity = learningActivityPersistence.update(learningActivity,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(learningActivity);
			}
	...
	public void deleteLearningActivity(long actId)
		...
		LearningActivity learningActivity = learningActivityPersistence.remove(actId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(learningActivity);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteLearningActivity(LearningActivity learningActivity)
	...
	private static Log _log = LogFactoryUtil.getLog(LearningActivityLocalServiceBaseImpl.class);
