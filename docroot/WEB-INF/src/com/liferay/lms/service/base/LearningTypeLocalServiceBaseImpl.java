...
/**
 * The base implementation of the learning type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.lms.service.impl.LearningTypeLocalServiceImpl}.
 * </p>
 *
 * @author cvicente
 * @see com.liferay.lms.service.impl.LearningTypeLocalServiceImpl
 * @see com.liferay.lms.service.LearningTypeLocalServiceUtil
 * @generated
 */
public abstract class LearningTypeLocalServiceBaseImpl
	implements LearningTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.lms.service.LearningTypeLocalServiceUtil} to access the learning type local service.
	 */
	 ...
	 */
	public LearningType addLearningType(LearningType learningType)
		throws SystemException {
		learningType.setNew(true);

		learningType = learningTypePersistence.update(learningType, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(learningType);
			}
	 ...
	 */
	public LearningType createLearningType(long typeId) {
		return learningTypePersistence.create(typeId);
	}
	...
	public void deleteLearningType(long typeId)
		...
		LearningType learningType = learningTypePersistence.remove(typeId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(learningType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteLearningType(LearningType learningType)
		throws SystemException {
		learningTypePersistence.remove(learningType);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return learningTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return learningTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public LearningType fetchLearningType(long typeId)
		throws SystemException {
		return learningTypePersistence.fetchByPrimaryKey(typeId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LearningType getLearningType(long typeId)
		throws PortalException, SystemException {
		return learningTypePersistence.findByPrimaryKey(typeId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return learningTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<LearningType> getLearningTypes(int start, int end)
		throws SystemException {
		return learningTypePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLearningTypesCount() throws SystemException {
		return learningTypePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public LearningType updateLearningType(LearningType learningType)
		throws SystemException {
		return updateLearningType(learningType, true);
	}
	...
	public LearningType updateLearningType(LearningType learningType,
		...
		learningType = learningTypePersistence.update(learningType, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.lms.model.LearningType",
			learningTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.lms.model.LearningType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = learningTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(LearningTypeLocalServiceBaseImpl.class);
